...
class DimensionGroupVirtual : public DimensionGroup
{
 public:
  ...
  {
   public:
    DGVirtualOrderedIterator(Filter *f_to_iterate, int b_dim, DimensionVector &dims, _int64 *ppos, IndexTable **tt,
                             PackOrderer *po);
 ...
 private:
  ...
  _int64
      *pack_pos;  // table of size = number of packs in base_dim; the first position of a given pack in all IndexTables
  bool *nulls_possible;
};
