...
class MysqlExpression : public boost::noncopyable DEBUG_STATEMENT(
                            DEBUG_COMA public DestructionDebugger<MysqlExpression>)
{
 public:
  ...
  typedef std::map<VarID, ValueOrNull *>
      BufOfVars;  // map of buffers to pass current values of variables during execution
