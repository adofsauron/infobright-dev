...
AttrPack::AttrPack(PackCoordinate pc, AttributeType attr_type, int inserting_mode, bool no_compression,
                   DataCache *owner)
    : m_prev_pack(NULL),
      m_next_pack(NULL),
      pack_no(pack_no),
...
bool AttrPack::ShouldNotCompress() { return (no_compression || (inserting_mode == 1 && no_obj < 0x10000)); }
