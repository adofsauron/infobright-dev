...
class AttributeTypeInfo
{
 public:
  ...
  inline static bool IsRealType(AttributeType attr_type) { return attr_type == RC_FLOAT || attr_type == RC_REAL; }

  inline static bool IsNumericType(AttributeType attr_type)
  {
    return IsInteger32Type(attr_type) || attr_type == RC_BIGINT || attr_type == RC_NUM || attr_type == RC_FLOAT ||
           attr_type == RC_REAL;
  }
  ...
  inline static bool IsTxtType(AttributeType attr_type) { return attr_type == RC_STRING || attr_type == RC_VARCHAR; }

  inline static bool IsCharType(AttributeType attr_type) { return attr_type == RC_STRING; }
