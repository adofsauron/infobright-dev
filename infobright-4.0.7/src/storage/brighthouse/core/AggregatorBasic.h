...
class AggregatorAvg64 : public Aggregator
{
 public:
  ...
  {
    prec_factor = PowOfTen(precision);
  ...
  virtual void Reset(unsigned char *buf)
  {
    *((double *)buf) = 0;
    *((_int64 *)(buf + 8)) = 0;
  }
