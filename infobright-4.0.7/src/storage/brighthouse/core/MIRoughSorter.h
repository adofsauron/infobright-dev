...
class MINewContentsRSorter  // Rough sorter of the new contents of MultiIndex
{
 ...
 private:
  ...
  static const _int64 OMIT_IF_SORTED = 500;  // a minimal portion of sorted data which will not be included in sorting
                                             // (if placed on the beginning of a new sorting)
  static const _int64 OPT_SORT_SIZE =
      60000;  // after finding such number of rows worth sorting, find the first appropriate place and sort
