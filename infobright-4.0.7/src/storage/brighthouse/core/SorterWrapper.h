...
class SorterWrapper
{
 public:
  ...
  _int64 GetValue64(int col, bool &is_null) { return scol[col].GetValue64(cur_val, cur_mit, is_null); }

  RCBString GetValueT(int col) { return scol[col].GetValueT(cur_val, cur_mit); }
