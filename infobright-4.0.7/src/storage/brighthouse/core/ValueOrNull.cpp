...
DataType::DataType(AttributeType atype, int prec, int scale, DTCollation collation) : precision(prec)
{
  valtype = VT_NOTKNOWN;
  attrtype = atype;
  fixscale = scale;
  ...
  switch (attrtype)
  {
    case RC_INT:
      valtype = VT_FIXED;
      fixmax = MAX(BH_INT_MAX, -BH_INT_MIN);
      break;
    case RC_BIGINT:
      valtype = VT_FIXED;
      fixmax = MAX(BH_BIGINT_MAX, -BH_BIGINT_MIN);
      break;
    case RC_MEDIUMINT:
      valtype = VT_FIXED;
      fixmax = MAX(BH_MEDIUMINT_MAX, -BH_MEDIUMINT_MIN);
      break;
    case RC_SMALLINT:
      valtype = VT_FIXED;
      fixmax = MAX(BH_SMALLINT_MAX, -BH_SMALLINT_MIN);
      break;
    case RC_BYTEINT:
      valtype = VT_FIXED;
      fixmax = MAX(BH_TINYINT_MAX, -BH_TINYINT_MIN);
      break;
