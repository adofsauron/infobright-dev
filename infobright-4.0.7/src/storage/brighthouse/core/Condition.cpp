...
SingleTreeCondition::SingleTreeCondition(CQTerm e1, Operator op, CQTerm e2, CQTerm e3, TempTable *t, int no_dims,
                                         char like_esc)
{
...
void SingleTreeCondition::AddDescriptor(LogicalOperator lop, CQTerm e1, Operator op, CQTerm e2, CQTerm e3, TempTable *t,
